...
def calculate_old_tax(income, deductions):
    ...
    cess = tax * 0.04
    return round(tax, 2), round(cess, 2)
...
# New Tax Regime
with tab1:
    new_tax, new_cess = calculate_new_tax(income)
...
with tab2:
    ...
    old_tax, old_cess = calculate_old_tax(income, total_deductions)
